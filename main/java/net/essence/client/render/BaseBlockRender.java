...
public class BaseBlockRender
{
	...
	public void renderInvBlock(EnumSet<ForgeDirection> sides, BlockModOre block, ItemStack item, Tessellator tess, int color, RenderBlocks renderer)
	{
	...
	public void renderInventory(BlockModOre block, ItemStack item, RenderBlocks renderer, ItemRenderType type, Object[] data)
	{
	...
	public static void postRenderInWorld(RenderBlocks renderer)
	{
		renderer.uvRotateBottom = renderer.uvRotateEast = renderer.uvRotateNorth = renderer.uvRotateSouth = renderer.uvRotateTop = renderer.uvRotateWest = 0;
	}
	...
	public void renderTile(BlockModOre block, TileEntity tile, Tessellator tess, double x, double y, double z, float f, RenderBlocks renderer)
	{
		ForgeDirection forward = ForgeDirection.SOUTH;
		ForgeDirection up = ForgeDirection.UP;
