...
public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
		...
		this.foot.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
		this.foot1.rotateAngleX = MathHelper.cos(par1 * 0.6662F + (float)Math.PI) * 1.4F * par2;
		this.foot2.rotateAngleX = MathHelper.cos(par1 * 0.6662F + (float)Math.PI) * 1.4F * par2;
		this.foot3.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.4F * par2;
		this.head.rotateAngleY = par4 / (180F / (float)Math.PI);
		this.head.rotateAngleX = par5 / (180F / (float)Math.PI);
		this.jaw.rotateAngleY = par4 / (180F / (float)Math.PI);
		this.jaw.rotateAngleX = par5 / (180F / (float)Math.PI);
		this.scale2.rotateAngleY = par4 / (180F / (float)Math.PI);
		this.scale2.rotateAngleX = par5 / (180F / (float)Math.PI);
