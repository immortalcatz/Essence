...
public class ModelInsecto extends ModelBase {
	...
	private ModelRenderer TailSpike;
	...
	public ModelInsecto() {
		...
		LeftFoot.addBox(-1F, 0F, -1F, 2, 2, 5);
		LeftFoot.setRotationPoint(-2F, 22F, -1F);
		LeftFoot.setTextureSize(128, 64);
		LeftFoot.mirror = true;
		setRotation(LeftFoot, 0F, 0F, 0F);
		RightFoot = new ModelRenderer(this, 38, 9);
		RightFoot.addBox(-1F, 0F, -1F, 2, 2, 5);
		RightFoot.setRotationPoint(2F, 22F, -1F);
		...
		RightArm2.addBox(0F, 0F, 0F, 2, 2, 11);
		RightArm2.setRotationPoint(10F, 11.5F, -8F);
		...
		LeftArm2.addBox(0F, 0F, 0F, 2, 2, 11);
		LeftArm2.setRotationPoint(-12F, 10F, -8F);
	...
	@Override
	@SuppressWarnings("The hard part..")
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
		this.RightLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.0F * par2;
		this.LeftLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662F + (float)Math.PI) * 1.0F * par2;
		this.RightLeg.rotateAngleY = 0.0F;
		this.LeftLeg.rotateAngleY = 0.0F;
		Tail1.rotateAngleX = MathHelper.cos(par1 * 0.2662F) * 0.7F * par2 + 0.5F;
		Tail2.rotateAngleX = Tail1.rotateAngleX + 1.5F;
		Tail3.rotateAngleX = Tail2.rotateAngleX + 1.2F;
		TailSpike.rotateAngleX = Tail3.rotateAngleX + 0.0F;
		Tail2.rotationPointY = 8.0F;
		Tail2.rotationPointZ = 10.0F;
		Tail3.rotationPointY = -0.5F;
		Tail3.rotationPointZ = 8.0F;
		TailSpike.rotationPointY = -0.5F;
		TailSpike.rotationPointZ = 0.0F;
		RightArm1.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.0F * par2;
		RightArm2.rotateAngleX = MathHelper.cos(par1 * 0.6662F) * 1.0F * par2 + 3.0F;
		RightArm2.rotationPointX = 7.0F; 
		RightArm2.rotationPointZ = 2.0F; 
		RightArm2.rotationPointY = 11.0F; 
		LeftArm1.rotateAngleX = MathHelper.cos(par1 * 0.6662F + (float)Math.PI) * 1.0F * par2;
		LeftArm2.rotateAngleX = MathHelper.cos(par1 * 0.6662F + (float)Math.PI) * 1.0F * par2 + 3.0F;
		LeftArm2.rotationPointX = -7.0F; 
		LeftArm2.rotateAngleZ = 0.5F + (float)Math.PI; 
		LeftArm2.rotationPointZ = 2.5F;
		LeftArm2.rotationPointY = 9.0F; 
	}
}