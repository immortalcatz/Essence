...
public class LayerFourfaHeldItem implements LayerRenderer {
    ...
    public void doRenderLayer(EntityLivingBase e, float f, float f1, float f2, float f3, float f4, float f5, float f6) {
        ...
        if(itemstack != null) {
            ...
            minecraft.getItemRenderer().renderItem(e, new ItemStack(EssenceItems.flameBow), ItemCameraTransforms.TransformType.THIRD_PERSON);
            GL11.glPopMatrix();          
            GL11.glPushMatrix();
            GL11.glTranslatef(-0.75F, 0.6F, 0.0F);
            minecraft.getItemRenderer().renderItem(e, new ItemStack(EssenceItems.frozenBow), ItemCameraTransforms.TransformType.THIRD_PERSON);
            GL11.glPopMatrix();
            GL11.glPushMatrix();
            GL11.glTranslatef(-1.25F, 0.6F, 0.0F);
            minecraft.getItemRenderer().renderItem(e, new ItemStack(EssenceItems.poisonBow), ItemCameraTransforms.TransformType.THIRD_PERSON);
            GL11.glPopMatrix();
