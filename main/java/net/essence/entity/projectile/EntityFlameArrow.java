...
public class EntityFlameArrow extends EntityArrow implements IProjectile {
			...
			if (movingobjectposition != null) {
				if (movingobjectposition.entityHit != null) {
					...
					if (this.field_145790_g.getMaterial() != Material.air) {
						this.field_145790_g.onEntityCollidedWithBlock(this.worldObj, blockpos1, iblockstate, this);
					}
				}
			}
	...
	public void writeEntityToNBT(NBTTagCompound tagCompound) {
		...
		ResourceLocation resourcelocation = (ResourceLocation)Block.blockRegistry.getNameForObject(this.field_145790_g);
