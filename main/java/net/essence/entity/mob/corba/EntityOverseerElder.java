...
public class EntityOverseerElder extends EntityModFlying {
	...
	protected void dropFewItems(boolean b, int j) {
		if(rand.nextInt(1) == 0) dropItem(EssenceItems.overseeingEye, 1);
		super.dropFewItems(b, j);
		if(rand.nextInt(5) == 0) dropItem(EssenceItems.collectorRock, 2);
		super.dropFewItems(b, j);
		if(rand.nextInt(10) == 0) dropItem(EssenceItems.collectorRock, 4);
		super.dropFewItems(b, j);
		if(rand.nextInt(50) == 0) dropItem(EssenceItems.overseeingTablet, 1);
		super.dropFewItems(b, j);
	}
