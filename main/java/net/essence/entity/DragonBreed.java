...
public class DragonBreed {
    ...
    public boolean isHabitatEnvironment(EntityDragon dragon) {
        return false;
    }
    
    public void onEnable(EntityDragon dragon) {
    }
    
    public void onDisable(EntityDragon dragon) {
    }
    
    public void onUpdate(EntityDragon dragon) {
    }
    
    public void onDeath(EntityDragon dragon) {
    }
    
    public String getLivingSound(EntityDragon dragon) {
        if (dragon.getRNG().nextInt(3) == 0) {
            return "mob.enderdragon.growl";
        } else {
            return "mob.enderdragon.breathe";
        }
    }
    
    public String getHurtSound(EntityDragon dragon) {
        return "mob.enderdragon.hit";
    }
    
    public String getDeathSound(EntityDragon dragon) {
