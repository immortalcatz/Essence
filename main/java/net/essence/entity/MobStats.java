...
public class MobStats {
	...
	public static double normalSpeed = 0.36, follow = 20, knockBackResistance = 0.0D;

	public static final int witheringBeastBossID = 0, netherBeastBossID = 1, calciaBossID = 2, wraithBossID = 3;

	//Overworld
	public static double spyclopsHealth = 40.0D, spyclopsDamage = 9.0D, spyclopsSpeed = normalSpeed, spyclopsFollowRange = follow;
	...
	public static double calciaHealth = 50.0D, calciaDamage = 10.0D, calciaSpeed = normalSpeed, calciaFollowRange = follow;
