...
public class MapGenBoilingCaves extends MapGenBase {
    ...
    protected boolean func_175793_a(IBlockState p_175793_1_, IBlockState p_175793_2_) {
        return p_175793_1_.getBlock() == EssenceBlocks.ashBlock ? true : (p_175793_1_.getBlock() == EssenceBlocks.hotBlock ? true : (p_175793_1_.getBlock() == EssenceBlocks.hotBlock ? true : false));
    }
    ...
    private boolean isTopBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ) {
        ...
        return (isExceptionBiome(biome) ? state.getBlock() == EssenceBlocks.hotBlock : state.getBlock() == biome.topBlock);
    }
