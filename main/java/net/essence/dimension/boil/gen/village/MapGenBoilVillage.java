...
public class MapGenBoilVillage extends MapGenStructure
{
    ...
    public static List villageSpawnBiomes = Arrays.asList(new BiomeGenBase[] {DimensionHelper.boiling});
    ...
    public MapGenBoilVillage()
    {
        this.field_82665_g = 32;
        this.field_82666_h = 8;
    }

    public MapGenBoilVillage(Map p_i2093_1_)
    {
        this();
    ...
    {
        return new MapGenBoilVillage.Start(this.worldObj, this.rand, p_75049_1_, p_75049_2_, this.terrainType);
    }
