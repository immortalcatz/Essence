...
public class MapGenBoilBridge extends MapGenStructure
{
    private List spawnList = new ArrayList();

    public MapGenBoilBridge()
    {
    ...
    {
        return new MapGenBoilBridge.Start(this.worldObj, this.rand, p_75049_1_, p_75049_2_);
    }
