...
{
    private static final StructureBoilBridgePieces.PieceWeight[] primaryComponents = new StructureBoilBridgePieces.PieceWeight[] {new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Straight.class, 30, 0, true), new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Crossing3.class, 10, 4), new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Crossing.class, 10, 4), new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Stairs.class, 10, 3), new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Throne.class, 5, 2), new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Entrance.class, 5, 1)};
    private static final StructureBoilBridgePieces.PieceWeight[] secondaryComponents = new StructureBoilBridgePieces.PieceWeight[] {new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Corridor5.class, 25, 0, true), new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Crossing2.class, 15, 5), new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Corridor2.class, 5, 10), new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Corridor.class, 5, 10), new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Corridor3.class, 10, 3, true), new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.Corridor4.class, 7, 2), new StructureBoilBridgePieces.PieceWeight(StructureBoilBridgePieces.NetherStalkRoom.class, 5, 2)};
    ...
    public static class Corridor extends StructureBoilBridgePieces.Piece
        {
    ...
    public static class Corridor2 extends StructureBoilBridgePieces.Piece
        {
    ...
    public static class Corridor3 extends StructureBoilBridgePieces.Piece
        {
    ...
    public static class Corridor4 extends StructureBoilBridgePieces.Piece
        {
            ...
            public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
            {
                ...
                this.getNextComponentX((StructureBoilBridgePieces.Start)p_74861_1_, p_74861_2_, p_74861_3_, 0, b0, p_74861_3_.nextInt(8) > 0);
    ...
    public static class Corridor5 extends StructureBoilBridgePieces.Piece
        {
    ...
    public static class Crossing extends StructureBoilBridgePieces.Piece
        {
            ...
            public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
            {
                ...
                this.getNextComponentX((StructureBoilBridgePieces.Start)p_74861_1_, p_74861_2_, p_74861_3_, 0, 2, false);
    ...
    public static class Crossing2 extends StructureBoilBridgePieces.Piece
        {
    ...
    public static class Crossing3 extends StructureBoilBridgePieces.Piece
        {
            ...
            public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
            {
                ...
                this.getNextComponentX((StructureBoilBridgePieces.Start)p_74861_1_, p_74861_2_, p_74861_3_, 3, 8, false);
    ...
    public static class End extends StructureBoilBridgePieces.Piece
        {
    ...
    public static class Entrance extends StructureBoilBridgePieces.Piece
        {
    ...
    public static class NetherStalkRoom extends StructureBoilBridgePieces.Piece
        {
    ...
    abstract static class Piece extends StructureComponent
        {
            ...
            private int getTotalWeight(List p_74960_1_)
            {
                boolean flag = false;
                int i = 0;
                StructureBoilBridgePieces.PieceWeight pieceweight;

                for (Iterator iterator = p_74960_1_.iterator(); iterator.hasNext(); i += pieceweight.field_78826_b)
                {
                    pieceweight = (StructureBoilBridgePieces.PieceWeight)iterator.next();
    ...
    public static class Stairs extends StructureBoilBridgePieces.Piece
        {
    ...
    public static class Straight extends StructureBoilBridgePieces.Piece
        {
    ...
    public static class Throne extends StructureBoilBridgePieces.Piece
        {
