...
public class WorldGenCorbaFarm extends WorldGenerator {
	...
	public boolean generate(World w, Random r, BlockPos pos) {
		...
		Block crop = EssenceBlocks.tomatoCrop;
		WorldGenAPI.addRectangle(11, 9, 5, w, x, y - 4, z, EssenceBlocks.corbaStone);
		WorldGenAPI.addRectangle(11, 9, 1, w, x, y + 1, z, EssenceBlocks.corbaGrass);
