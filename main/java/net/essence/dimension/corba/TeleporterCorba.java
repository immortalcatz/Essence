...
public class TeleporterCorba extends Teleporter {
	...
	public boolean isBlockPortal(World var1, int var2, int var3, int var4) {
		return var1.getBlockState(new BlockPos(var2, var3, var4)) == EssenceBlocks.corbaPortal.getDefaultState();
	}
	...
	private void makePortalAt(World world, int x, int y, int z) {
		...
		world.setBlockState(new BlockPos(x + 1, y, z + 3), EssenceBlocks.corbaPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 2, y, z + 3), EssenceBlocks.corbaPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 3, y, z + 3), EssenceBlocks.corbaPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 4, y, z), EssenceBlocks.corbaPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 4, y, z + 1), EssenceBlocks.corbaPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 4, y, z + 2), EssenceBlocks.corbaPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 1, y, z - 1), EssenceBlocks.corbaPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 2, y, z - 1), EssenceBlocks.corbaPortalFrame.getDefaultState());
		world.setBlockState(new BlockPos(x + 3, y, z - 1), EssenceBlocks.corbaPortalFrame.getDefaultState());

		world.setBlockState(new BlockPos(x + 1, y, z), EssenceBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 2, y, z), EssenceBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 3, y, z), EssenceBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 1, y, z + 1), EssenceBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 2, y, z + 1), EssenceBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 3, y, z + 1), EssenceBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 1, y, z + 2), EssenceBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 2, y, z + 2), EssenceBlocks.corbaPortal.getDefaultState());
		world.setBlockState(new BlockPos(x + 3, y, z + 2), EssenceBlocks.corbaPortal.getDefaultState());
	}
}
