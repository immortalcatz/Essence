...
public class TeleporterDepths extends Teleporter {
	...
	public boolean isBlockPortal(World var1, int var2, int var3, int var4) {
		return var1.getBlockState(new BlockPos(var2, var3, var4)) == EssenceBlocks.depthsPortal.getDefaultState();
	}
	...
	private void makePortalAt(World w, int x, int y, int z) {
		y = 3;
		WorldGenAPI.addRectangle(1, 4, 5, w, x + 2, y + 1, z + 1, EssenceBlocks.depthsPortalFrame);
