                            ...
                            for(int j2 = l; j2 <= k1; ++j2) {
                                ...
                                if(d12 * d12 + d13 * d13 + d14 * d14 < 1.0D) {
                                    ...
                                    if(w.getBlockState(blockpos1).getBlock().isReplaceableOreGen(w, blockpos1, this.replace)) {
                                    	w.setBlockState(new BlockPos(x, y, z), EssenceBlocks.cloudiaGrass.getDefaultState(), 2);
                                    	w.setBlockState(new BlockPos(x, y - 1, z), EssenceBlocks.cloudiaDirt.getDefaultState(), 2);
                                    	w.setBlockState(new BlockPos(x, y - 2, z), this.stone, 2);
                                    	w.setBlockState(new BlockPos(x, y - 3, z), this.stone, 2);
                                    	
                                    	if(r.nextInt(18) == 0) {
                                    		w.setBlockState(blockpos1.down(3), EssenceBlocks.luniteOre.getDefaultState(), 2);
                                    	}
                                    }
                                }
                            }
