...
public class WorldGenNetherTower extends WorldGenerator {
	...
	public boolean generate(World w, Random r, BlockPos pos) {
		...
		w.setBlockState(new BlockPos(x + 13, y + height + 10, z + 1), EssenceBlocks.redGems.getDefaultState());
		w.setBlockState(new BlockPos(x + 1, y + height + 10, z + 8), EssenceBlocks.redGems.getDefaultState());
		w.setBlockState(new BlockPos(x + 13, y + height + 10, z + 8), EssenceBlocks.redGems.getDefaultState());
