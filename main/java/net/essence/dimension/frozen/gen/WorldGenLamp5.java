...
public class WorldGenLamp5 extends WorldGenerator {
	...
	public boolean generate(World world, Random r, BlockPos pos) {
		...
		world.setBlockState(new BlockPos(i + 0, j + 1, k + 1), EssenceBlocks.workshopStone.getDefaultState(), 2);
		...
		world.setBlockState(new BlockPos(i + 2, j + 1, k + 1), EssenceBlocks.workshopStone.getDefaultState(), 2);
