...
public class WorldGenNormalEucaTree extends WorldGenAbstractTree {
	...
	public WorldGenNormalEucaTree(boolean var1, int var2, int var3, int var4) {
		super(var1);
							...
							for(int k2 = par5 - l1; k2 <= par5 + l1; ++k2) {
								...
								if(Math.abs(j2) != l1 || Math.abs(l2) != l1 || par2Random.nextInt(2) != 0 && i3 != 0) {
									...
									if(block1.isAir(par1World, new BlockPos(i2, k1, k2)) || block1.isLeaves(par1World, new BlockPos(i2, k1, k2))) {
										this.func_175905_a(par1World, new BlockPos(i2, k1, k2), leaves, this.metaLeaves);
									}
								}
							}
						}
