...
public class Essence {
	...
	public static final Fluid tropicalWater = new Fluid("tropicalWaterFluid");
	...
	public static void preInit(FMLPreInitializationEvent event) {
		...
		event.getModMetadata().credits = "The_SlayerMC - Creator, DrizzlePop - Textures/Models, Eternaldoom - Helped with misc things";
