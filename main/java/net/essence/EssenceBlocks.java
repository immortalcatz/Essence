...
public class EssenceBlocks {
	...
	public static void addBlockNames() {
		...
		blockName.add("workshopStairs");
		blockName.add("workshopLamp");
		blockName.add("workshopFence");
		blockName.add("candyCane");
		blockName.add("frozenPortal");
		blockName.add("frozenGlass");
		blockName.add("frozenGlassPane");
		blockName.add("frozenStone");
		blockName.add("frozenGrass");
		blockName.add("frozenDirt");
		blockName.add("hellstoneOre");
		blockName.add("shadiumOre");
		blockName.add("luniumOre");
		blockName.add("celestiumOre");
		blockName.add("flairiumOre");
		blockName.add("ashual");
		blockName.add("sapphireOre");
		blockName.add("hellstoneBlock");
		blockName.add("shadiumBlock");
		blockName.add("luniumBlock");
		blockName.add("celestiumBlock");
		blockName.add("flairiumBlock");
		blockName.add("sapphireBlock");
		blockName.add("eucaDirt");
		blockName.add("eucaGrass");
		blockName.add("eucaStone");
		blockName.add("eucaLog");
		blockName.add("eucaPlank");
		blockName.add("eucaStairs");
		blockName.add("redEucaLeaves");
		blockName.add("greenEucaLeaves");
		blockName.add("blueEucaLeaves");
		blockName.add("eucaSapling");
		blockName.add("depthsDirt");
		blockName.add("depthsGrass");
		blockName.add("depthsStone");
		blockName.add("depthsLog");
		blockName.add("depthsPlank");
		blockName.add("depthsStairs");
		blockName.add("depthsLeaves");
		blockName.add("godDirt");
		blockName.add("godGrass");
		blockName.add("godStone");
		blockName.add("eucaPortal");
		blockName.add("eucaPortalFrame");
		blockName.add("depthsPortal");
		blockName.add("depthsPortalFrame");
		blockName.add("boilingPortal");
		...
		blockName.add("dungeonChiseledBrick");
		blockName.add("dungeonBrickCarved");
		blockName.add("dungeonLamp");
		blockName.add("dungeonBrickStairs");
		blockName.add("dungeonCrackedBrickStairs");
		blockName.add("dungeonChiseledBrickStairs");
		blockName.add("dungeonBrickCarvedStairs");
		blockName.add("dungeonLampStairs");
		blockName.add("dungeonBrickFence");
		blockName.add("dungeonCrackedBrickFence");
		blockName.add("dungeonChiseledBrickFence");
		blockName.add("dungeonBrickCarvedFence");
		blockName.add("dungeonLampFence");
		blockName.add("hotBrick");
		blockName.add("hotBrickFence");
		blockName.add("hotBrickStairs");
		blockName.add("hotGlass");
		blockName.add("hotGlassPane");
		blockName.add("smoothGlass");
		blockName.add("smoothGlassPane");
		blockName.add("netherBeastStatue");
		blockName.add("witheringBeastStatue");
		blockName.add("calciaStatue");
		blockName.add("eudorStatue");
		blockName.add("enrichedEnchantmentTable");
		blockName.add("hotDoorBlock");
		blockName.add("christmasLights");
		blockName.add("eucaTallGrass");
