...
public class EssenceItems {
	...
	public static void addItems() {
		items.add(hellstoneIngot);
		items.add(shadiumIngot);
		items.add(celestiumIngot);
		items.add(luniumIngot);
		items.add(flairiumIngot);
		items.add(ash);
		items.add(sapphire);
		items.add(hellstoneClump);
		items.add(shadiumClump);
		items.add(luniumClump);
		items.add(spawnerClump);
		items.add(spawnerBar);
		items.add(flameCoin);
		items.add(chaosCannon);
		items.add(hellstoneMultiTool);
		items.add(shadiumMultiTool);
		items.add(celestiumMultiTool);
		items.add(flairiumMultiTool);
		items.add(luniumMultiTool);
		items.add(sapphireMultiTool);
		items.add(hellstonePickaxe);
		items.add(shadiumPickaxe);
		items.add(celestiumPickaxe);
		items.add(luniumPickaxe);
		items.add(flairiumPickaxe);
		items.add(sapphirePickaxe);
		items.add(hellstoneShovel);
		items.add(shadiumShovel);
		items.add(celestiumShovel);
		items.add(flairiumShovel);
		items.add(sapphireShovel);
		items.add(hellstoneAxe);
		items.add(luniumShovel);
		items.add(luniumAxe);
		items.add(shadiumAxe);
		items.add(celestiumAxe);
		items.add(flairiumAxe);
		items.add(sapphireAxe);
		items.add(hellstoneHoe);
		items.add(shadiumHoe);
		items.add(celestiumHoe);
		items.add(flairiumHoe);
		items.add(sapphireHoe);
		items.add(luniumHoe);
		items.add(hellstoneSword);
		items.add(luniumSword);
		items.add(shadiumSword);
		items.add(celestiumSword);
		items.add(flairiumSword);
		items.add(sapphireSword);
		items.add(poisonSword);
		items.add(cloudSlicer);
		items.add(dragonsTooth);
		items.add(netherBeastSword);
		items.add(witheringBeastSword);
		items.add(calciaSword);
		items.add(championsSword);
		items.add(theWraith);
		items.add(eucaPortalGem);
		items.add(depthsPortalGem);
		items.add(calciaOrb);
		items.add(netherBeastOrb);
		items.add(witheringBeastOrb);
		//items.add(eudorOrb);
		items.add(weakEssencePotion);
		items.add(strongEssencePotion);
		items.add(weakDarkEnergyPotion);
		items.add(strongDarkEnergyPotion);
		items.add(luniumHelmet);
		items.add(luniumChest);
		items.add(luniumLegs);
		items.add(luniumBoots);
		items.add(hellstoneHelmet);
		items.add(shadiumHelmet);
		items.add(celestiumHelmet);
		items.add(flairiumHelmet);
		items.add(sapphireHelmet);
		items.add(condensedDiamondHelmet);
		items.add(hellstoneChest);
		items.add(shadiumChest);
		items.add(celestiumChest);
		items.add(flairiumChest);
		items.add(sapphireChest);
		items.add(condensedDiamondChest);
		items.add(hellstoneLegs);
		items.add(shadiumLegs);
		items.add(spawners);
		items.add(celestiumLegs);
		items.add(flairiumLegs);
		items.add(sapphireLegs);
		items.add(condensedDiamondLegs);
		items.add(hellstoneBoots);
		items.add(shadiumBoots);
		items.add(celestiumBoots);
		items.add(flairiumBoots);
		items.add(sapphireBoots);
		items.add(condensedDiamondBoots);
		items.add(backBiter);
		items.add(dawnBreaker);
		items.add(tempestBattleaxe);
		items.add(staffOfHellstone);
		items.add(doomsBringer);
		items.add(conjuringStaff);
		items.add(staffOfEnlightment);
		items.add(staffOfGreenpace);
		items.add(wizardsStar);
		items.add(teleportationStaff);
		items.add(goldenSteak);
		items.add(goldenSteakOP);
		items.add(goldenPotato);
		items.add(goldenPotatoOP);
		items.add(goldenPork);
		items.add(goldenPorkOP);
		items.add(hotDoorItem);
		items.add(eucaMeat);
	}
	...
	public static void addItemNames() {
		...
		itemNames.add("normalGoldenPotato");
		itemNames.add("OPGoldenPotato");
		itemNames.add("normalGoldenPork");
