	...
	public static class Size
	{
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				{
					this.field_150867_a.setBlockState(blockpos.up(j), EssenceBlocks.frozenPortal.getDefaultState().withProperty(BlockFrozenPortal.field_176550_a, this.field_150865_b), 2);
				}
			}
		}
	}
