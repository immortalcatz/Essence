...
public class BlockEssenceWallSign extends BlockEssenceSign {

	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);

	public BlockEssenceWallSign(String name) {
		super(name);
	...
	public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos) {
		...
		switch (BlockEssenceWallSign.SwitchEnumFacing.FACING_LOOKUP[enumfacing.ordinal()]) {
		case 1:
