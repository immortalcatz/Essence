...
public class JourneyItems {
	...
	**/
	...
	public static final Item staringBow = new ItemModBow("staringBow", "Staring Bow", 384, 3, essenceArrow,"Harms and poisons enemies", EntityEssenceArrow.class);
	public static final Item deathPiercerBow = new ItemModBow("deathPiercerBow", "Death Piercer Bow", 384, 3, essenceArrow,"Harms and stuns enemies", EntityEssenceArrow.class);
	public static final Item fusionBow = new ItemModBow("fusionBow", "Fusion Bow", 384, 3, essenceArrow,"Explodes on impact", EntityEssenceArrow.class);
	public static final Item springBow = new ItemModBow("springBow", "Spring Bow", 384, 3, essenceArrow,"Very fast pullback", EntityEssenceArrow.class);
	public static final Item starlightBow = new ItemModBow("starlightBow", "Starlight Bow", 384, 3, essenceArrow,"Heals the player 1 heart and harms enemies", EntityHealthArrow.class);
	public static final Item wastefulBow = new ItemModBow("wastefulBow", "Wasteful Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item flamingBow = new ItemModBow("flamingBow", "Flaming Bow", 384, 3, essenceArrow,"Withers foe", EntityFlamingArrow.class);
	public static final Item blazingBow = new ItemModBow("blazingBow", "Blazing Bow", 384, 3, essenceArrow,"Withers foe", EntityFlamingArrow.class);
	public static final Item darkEnforcer = new ItemModBow("darkEnforcer", "Dark Enforcer", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item depthsBow = new ItemModBow("depthsBow", "Depths Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item frostbittenBow = new ItemModBow("frostbittenBow", "Frostbitten Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item frostyBow = new ItemModBow("frostyBow", "Frosty Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item charredBow = new ItemModBow("charredBow", "Charred Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item fluffyBow = new ItemModBow("fluffyBow", "Fluffy Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item golemBow = new ItemModBow("golemBow", "Golem Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item loggersBow = new ItemModBow("loggersBow", "Loggers Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item overgrownBow = new ItemModBow("overgrownBow", "Overgrown Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item overseerBow = new ItemModBow("overseerBow", "Overseer Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item woodlandBow = new ItemModBow("woodlandBow", "Woodland Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item rocsWing = new ItemModBow("rocsWing", "Rocs Wing", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item scaleBow = new ItemModBow("scaleBow", "Scale Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item mantleBow = new ItemModBow("mantleBow", "Mantle Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item coreExpender = new ItemModBow("coreExpender", "Core Expender", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item royalBow = new ItemModBow("royalBow", "Royal Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item darkTerraBow = new ItemModBow("darkTerraBow", "Dark Terra Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item lavenderBow = new ItemModBow("lavenderBow", "Lavender Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item terralightBow = new ItemModBow("terralightBow", "Terralight Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
	public static final Item terrianBow = new ItemModBow("terrianBow", "Terrian Bow", 384, 3, essenceArrow,"Withers foe", EntityEssenceArrow.class);
