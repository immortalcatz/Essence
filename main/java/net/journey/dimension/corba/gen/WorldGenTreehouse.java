...
public class WorldGenTreehouse extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, BlockPos pos) {
		...
		k-=5;
			...
			world.setBlockState(new BlockPos(i + 4, j + 0, k + 5), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 0, k + 6), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 1, k + 5), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 1, k + 6), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 2, k + 5), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 2, k + 6), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 3, k + 5), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 3, k + 6), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 4, k + 5), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 4, k + 6), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 5, k + 5), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 5, k + 6), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 6, k + 5), Blocks.ladder.getDefaultState());
			world.setBlockState(new BlockPos(i + 4, j + 6, k + 6), Blocks.ladder.getDefaultState());
			if(!world.isRemote) {
