...
public class WorldGenHugeCorbaSpruceTree extends WorldGenCorbaHugeTree
{
	...
	public boolean generate(World p_76484_1_, Random p_76484_2_, BlockPos pos) {
		...
		else
		{
			...
			for (int i1 = 0; i1 < l; ++i1)
			{
				...
				{
					this.func_175905_a(p_76484_1_, new BlockPos(p_76484_3_, p_76484_4_ + i1, p_76484_5_), log, 0);
				}
				...
				if (i1 < l - 1)
				{
					...
					{
						this.func_175905_a(p_76484_1_, new BlockPos(p_76484_3_ + 1, p_76484_4_ + i1, p_76484_5_), log, 0);
					}
					...
					{
						this.func_175905_a(p_76484_1_, new BlockPos(p_76484_3_ + 1, p_76484_4_ + i1, p_76484_5_ + 1), log, 0);
					}
					...
					{
						this.func_175905_a(p_76484_1_, new BlockPos(p_76484_3_, p_76484_4_ + i1, p_76484_5_ + 1), log, 0);
					}
				}
			}
	...
	private void func_150540_a(World p_150540_1_, int p_150540_2_, int p_150540_3_, int p_150540_4_)
	{
		for (int l = p_150540_3_ + 2; l >= p_150540_3_ - 3; --l)
		{
			...
			{
				this.func_175905_a(p_150540_1_, new BlockPos(p_150540_2_, l, p_150540_4_), JourneyBlocks.corbaStone, 2);
				break;
			}
