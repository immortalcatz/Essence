				...
				if (isSoil && par4 < 256 - l - 1) {
							...
							for(int k2 = par5 - l1; k2 <= par5 + l1; ++k2) {
								...
								if(Math.abs(j2) != l1 || Math.abs(l2) != l1 || par2Random.nextInt(2) != 0 && i3 != 0) {
									...
									if(block1.isAir(par1World, new BlockPos(i2, k1, k2)) || block1.isLeaves(par1World, new BlockPos(i2, k1, k2))) {
										this.func_175905_a(par1World, new BlockPos(i2 - 1, k1, k2 - 1), JourneyBlocks.depthsLeaves, this.metaLeaves);
									}
								}
							}
						}
					...
					for(k1 = 0; k1 < l; ++k1) {
						...
						if(block.isAir(par1World, new BlockPos(par3, par4 + k1, par5)) || block.isLeaves(par1World, new BlockPos(par3, par4 + k1, par5))) {
							this.func_175905_a(par1World, new BlockPos(par3, par4 + k1, par5 - 1), JourneyBlocks.depthsLog, this.metaWood);
							this.func_175905_a(par1World, new BlockPos(par3, par4 + k1, par5), JourneyBlocks.depthsLog, this.metaWood);
							this.func_175905_a(par1World, new BlockPos(par3 - 1, par4 + k1, par5 - 1), JourneyBlocks.depthsLog, this.metaWood);
							this.func_175905_a(par1World, new BlockPos(par3 - 1, par4 + k1, par5), JourneyBlocks.depthsLog, this.metaWood);
						}
					}
					par1World.setBlockState(new BlockPos(par3, par4 + l, par5), JourneyBlocks.depthsLights.getDefaultState());
					return true;
				} else {
					return false;
				}
