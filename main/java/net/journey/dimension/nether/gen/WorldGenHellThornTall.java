...
public class WorldGenHellThornTall extends WorldGenerator {
	...
	public boolean generate(World world, Random r, BlockPos pos) {
		int i = pos.getX() - 6, j = pos.getY() - 1, k = pos.getZ() - 6;
			world.setBlockState(new BlockPos(i + 0, j + 0, k + 0), JourneyBlocks.hellThornBottom.getDefaultState());
			world.setBlockState(new BlockPos(i + 0, j + 1, k + 0), JourneyBlocks.hellThornBottom.getDefaultState());
			...
			world.setBlockState(new BlockPos(i + 0, j + 10, k + 0), JourneyBlocks.hellThornTop.getDefaultState());
		return true;
	}
}
