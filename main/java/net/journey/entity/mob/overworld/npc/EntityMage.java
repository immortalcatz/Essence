...
public class EntityMage extends EntityModVillager {
	...
	public void addRecipies(MerchantRecipeList list) {
		...
		list.add(new MerchantRecipe(new ItemStack(JourneyItems.staffBase, 1), new ItemStack(JourneyItems.greenGem, 15), new ItemStack(JourneyItems.staffOfGreenpace)));
		list.add(new MerchantRecipe(new ItemStack(JourneyItems.staffBase, 1), new ItemStack(JourneyItems.hellstoneIngot, 15), new ItemStack(JourneyItems.staffOfHellstone)));
		list.add(new MerchantRecipe(new ItemStack(JourneyItems.staffBase, 1), new ItemStack(JourneyItems.purpleGem, 15), new ItemStack(JourneyItems.doomsBringer)));
		list.add(new MerchantRecipe(new ItemStack(JourneyItems.staffBase, 1), new ItemStack(JourneyItems.yellowGem, 5), new ItemStack(JourneyItems.wizardsStar)));
		...
		list.add(new MerchantRecipe(new ItemStack(JourneyItems.staffBase, 1), new ItemStack(JourneyItems.blueGem, 15), new ItemStack(JourneyItems.staffOfEnlightenment)));
