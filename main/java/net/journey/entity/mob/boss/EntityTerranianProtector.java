...
public class EntityTerranianProtector extends EntityEssenceBoss implements IBossDisplayData, IRangedAttackMob
{
    ...
    public EntityTerranianProtector(World worldIn)
    {
        super(worldIn);
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        ...
        else if (source != DamageSource.drown && !(source.getEntity() instanceof EntityTerranianProtector))
        {
