...
public class EntityShiverwolf extends EntityModTameable {
	...
	public EntityShiverwolf(World w) {
		super(w);
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(MobStats.shiverwolfSpeed);
		if(this.isTamed()) this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(MobStats.shiverwolfHealth);
		else this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(MobStats.shiverwolfHealth);
	}

	@Override
	public EntityAgeable createChild(EntityAgeable var1) {
		EntityShiverwolf e = new EntityShiverwolf(this.worldObj);
	...
	public void setTamed(boolean par1) {
		super.setTamed(par1);
		if(par1) this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(MobStats.eucaHopperHealthTamed);
		else this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(MobStats.eucaHopperHealth);
	}
	...
	public boolean func_142018_a(EntityLivingBase par1EntityLivingBase, EntityLivingBase par2EntityLivingBase) {
		if(!(par1EntityLivingBase instanceof EntityCreeper) && !(par1EntityLivingBase instanceof EntityGhast)) {
			if(par1EntityLivingBase instanceof EntityShiverwolf) {
				EntityShiverwolf pig = (EntityShiverwolf)par1EntityLivingBase;
