...
public class EntitySummoningFX extends EntityFX{
	...
	private static final ResourceLocation texture = new ResourceLocation(SlayerAPI.MOD_ID, "textures/particle/summoning.png");
	
	public EntitySummoningFX(World par1World, double x, double y, double z) {
