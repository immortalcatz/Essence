...
public class ModelHellwing extends ModelBiped {
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity par7Entity) {
        ...
        this.leftwing.rotateAngleZ = -this.rightwing.rotateAngleZ * 0.5F;
        this.rightwing1.rotateAngleZ = this.rightwing.rotateAngleZ * 0.5F;
        this.leftwing1.rotateAngleZ = -this.rightwing.rotateAngleZ * 0.5F;
